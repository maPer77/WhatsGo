...
// --------------------------------------------------------------------------------------- PASTE
document.getElementById("phoneNumber").addEventListener("paste", function(event) {
...
// --------------------------------------------------------------------------------------- whatsGo()
whatsGo = function (event) {

    event.preventDefault()
    let isMobile = mobileCheck()
    let input = document.getElementById('whatsappLink')
    let phoneNumber = document.getElementById('phoneNumber').value
    phoneNumber = phoneNumber.replace(/\D/g, '')
    let link
    if (isMobile) {
        link = `whatsapp://send?phone=55${phoneNumber}`
    } else {
        link = `https://web.whatsapp.com/send?phone=55${phoneNumber}`
    }
